...
extension Character {
    func isVowel(_ character: Character) -> Bool {
        if character.lowercased() == "a" || character.lowercased() == "e" || character.lowercased() == "i" || character.lowercased() == "o" || character.lowercased() == "u" {
            return true
        } else {
            return false
        }
...
myVowel.isVowel(myVowel)
myConsonant.isVowel(myConsonant)
